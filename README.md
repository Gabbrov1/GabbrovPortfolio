...
Basic Portfolio project used to display skills gained this far.

This project is also used as a way of learning more about the AWS suite.

This project, so far uses:
 - AWS S3 Bucket, for Image storage. IAM configured.
